...
public class Response {
    ...
    public Response(String id, String entity, long amount, long amountPaid, long amountDue, String currency, String receipt, Object offerID, String status, long attempts, Notes notes, long createdAt) {
        this.id = id;
        this.entity = entity;
        this.amount = amount;
